...
<div class="container-fluid py-4">
    ...
    <div class="mb-4">
        <h1 class="h3 font-weight-bold text-dark">
            <i class="fas fa-pencil-alt"></i> Tambah Berita Baru
        </h1>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            <div class="card shadow">
                ...
                <!-- Isi Berita -->
                <div class="form-group mb-4">
                    <label for="isi" class="form-label font-weight-bold">
                        Isi Berita
                    </label>
                    <textarea id="isi" 
                              name="isi" 
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('admin.berita.index') }}" class="btn btn-outline-secondary btn-lg">
